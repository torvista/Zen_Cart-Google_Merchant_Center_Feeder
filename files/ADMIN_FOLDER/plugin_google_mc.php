...
// sticky offset
$offset = !empty($_GET['offset']) ? (int)$_GET['offset'] : 1;
// sticky languages
...
<?php //todo use this to change the default and relocate the configuration switch GOOGLE_PRODUCTS_FEED_SORT to gID=6 ?>
          ...
          if ($langsMultiple !== false) { ?>
              ...
              //todo All languages
              //echo '<label class="control-label">TEXT_LANGUAGE_ALL:' . zen_draw_radio_field('langSelect', '0', $langSelect === '0', 'class="limiters form-control" id="langSelect"') . '</label></div>';
          } zen_draw_hidden_field('langSelect', $langSelect); ?>
