...
class google_base
{
    ...
    {
        return $this->included_categories_check(GOOGLE_PRODUCTS_POS_CATEGORIES, $products_id) && !$this->excluded_categories_check(GOOGLE_PRODUCTS_NEG_CATEGORIES, $products_id) && $this->included_manufacturers_check(
                GOOGLE_PRODUCTS_POS_MANUFACTURERS,
                $products_id
            ) && !$this->excluded_manufacturers_check(GOOGLE_PRODUCTS_NEG_MANUFACTURERS, $products_id);
    }
...
//availability: only "in_stock", "out_of_stock", "preorder" allowed
        ...
        if (defined('GOOGLE_PRODUCTS_SHIPPING_METHOD') && (GOOGLE_PRODUCTS_SHIPPING_METHOD !== '') && (GOOGLE_PRODUCTS_SHIPPING_METHOD !== 'none')) {
            ...
            if ((float)$shipping_rate >= 0) {
                ...
                // steve: createElement second parameter must be a string
