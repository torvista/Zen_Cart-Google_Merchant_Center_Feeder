...
define('TEXT_GOOGLE_PRODUCTS_PRODUCT_SUMMARY_ID', '#%1$u | %2$s | "%3$s" | price: %6$s | description "%4$s" (%5$u chars)');
define('TEXT_GOOGLE_PRODUCTS_PRODUCT_SUMMARY_MODEL', '%2$s (#%1$u) | "%3$s" | price: %6$s | description "%4$s" (%5$u chars)');
define('TEXT_GOOGLE_PRODUCTS_PRODUCT_SUMMARY_NAME', '"%3$s" (#%1$u) | %2$s | price: %6$s | description "%4$s" (%5$u chars)');
